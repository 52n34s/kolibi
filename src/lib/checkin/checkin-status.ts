...
export const CHECKIN_CARD_UNTIL_HOUR = 18;
...
/**
 * questions: open and still before CHECKIN_CARD_UNTIL_HOUR.
 * result: answered today — one line with the outcome, for the rest of the day.
 * hidden: everything else — including "open" past the window, which then
 * counts as a day without a check-in. Never a pop-up: this only drives an
 * inline card.
 */
